...
**Statistician** (1530), Greater Atlantic Regional Fisheries Office, National Marine Fisheries Service, NOAA. 06/08/2020 - present. 40 hrs/wk. ZP-03

*Duties:* Provide partner-driven analyses in support of marine fisheries monitoring, sustainable harvest, and protected resources. Serve as the program coordinator and lead programmer for the Catch Accounting and Monitoring System (CAMS) to integrate all fisheries dependent data sources from the Greater Atlantic Region (North Carolina to Maine) to create one set of official records for all users at the regional office and science center ([https://apps-garfo.fisheries.noaa.gov/cams](https://apps-garfo.fisheries.noaa.gov/cams)). Develop innovative analytical solutions to meet organizational needs and generate products for internal and external partners with specific deadlines. Work with partners and stakeholders to establish and provide the authoritative source of fisheries data science that meets needs for management, policy, and data life cycle decisions. Lead the development and integration of best data science practices including emerging technologies, semantic version control of software with GitHub actions for continuous integration, automated Oracle table and view creation, Apache Arrow use for speed and out-of-memory computation when needed, and literate programming for automated, reproducible reports, websites, and interactive intranet applications. Develop guides for other programmers to ensure consistent programming style and structure, news updates, and version control to ensure protection of the main production branch during development. Other regular duties include catch accounting, monitoring, and forecasting of catch to ensure fisheries closures when needed with adequate time for fleet notification and publication in the Federal Registry and collaborate with team members to support marine ecosystem data requests.


**Assistant Professor**, Dept. of Biology, Frostburg State University. 08/25/2016 - 06/07/2020. 40 hrs/wk.
...
**USGS Mendenhall Postdoctoral Fellow**, Research Ecologist (0408), Conte Anadromous Fish Research Laboratory, Leetown Science Center. GS-12. 06/29/2014 - 08/15/2016. 40 hrs/wk.
...
**Postdoctoral Fellow**, DOI Northeast Climate Science Center. University of Massachusetts. 01/15/2013 - 06/28/2014. 40 hrs/wk.
...
**Postdoctoral Research Associate**, University of New Hampshire. 05/25/2012 - 01/01/2013. 40 hrs/wk.
...
(citations = 1906, *h*-index = 21, *i*10-index = 26)  
...
Donini, J., A. Rodriguez, J. Drew, **D.J. Hocking**, S. Tetzlaff, and R. Speer. 2025. Home range, habitat use, and behaviors of Florida box turtles, *Terrapene carolina bauri* at an enclosed site in southwestern Florida. The Journal of North American Herpetology. 2025(1):59-70. [https://doi.org/10.17161/jnah.v2025i1.23826](https://doi.org/10.17161/jnah.v2025i1.23826)

Grant, E.H.C., J. Fleming, E. Bastiaans, A.B. Brand, J.L. Brooks Jacey\*, C. Devlin, E. Epp, M. Evans, M.C. Fisher-Reid, B. Gratwicke, K.L. Grayson Kristine, N.T. Haydt\*, R. Hernández-Pacheco, **D.J. Hocking**, A. Hyde, M. Losito, M.G. MacKnight, T.J.H. Matlaga, L. Mead, D. Muñoz, W.E. Peterman, V. Puza, C. Shafer, S.C. Sterrett, C. Sutherland, L.M. Thompson, A.R. Warwick, A.D. Wright, K. Yurewicz, and D.A.W. Miller. 2024. Range-wide salamander densities reveal a key component of terrestrial vertebrate biomass in eastern North American forests. Biology Letters. 20:20240033. [https://doi.org/10.1098/rsbl.2024.0033](https://doi.org/10.1098/rsbl.2024.0033), [Data](https://doi.org/10.5061/dryad.h44j0zpvf)

Knott, S.\*, R. Raesly, **D.J. Hocking**, J. Stauffer, and A. Welsh. 2024. Genomic evaluation of mud sunfish in the Atlantic slope drainage. Fisheries Research. [https://doi.org/10.1016/j.fishres.2024.107043](https://doi.org/10.1016/j.fishres.2024.107043)

Kessler, E.J., J.A. Crawford, W.E. Peterman, and **D.J. Hocking**. 2024. Reproductive ecology of Southern Pygmy Salamanders (<i>Desmognathus wrighti</i>) along an elevational gradient. Herpetologica. [https://doi.org/10.1655/Herpetologica-D-23-00049](https://doi.org/10.1655/Herpetologica-D-23-00049)

Salois, S.L.<sup>+</sup>, K.J.W. Hyde, A. Silver, A. Gangopadhyay, G. Gawarkiewicz, A.M. Mercer, B.A. Lowman, J.P. Manderson, S.K. Gaichas, **D.J. Hocking**, B. Galuardi, A.W. Jones, J. Kaelin, G. DiDomenico, K. Almeida, B. Bright, M. Lapp. 2023. Shelf break exchange processes influence the availability of the Northern Shortfin Squid, <i>Illex illecebrosus</i>, in the Northwest Atlantic. Fisheries Oceanography. 32(5):461-478 [https://doi.org/10.1111/fog.12640](https://doi.org/10.1111/fog.12640)
...
**Hocking, D.J.**, K. O'Neil, and B.H. Letcher. 2018. Preprint Not Peer Reviewed: A hierarchical model of daily stream temperature for regional predictions. [[Code](https://github.com/Conte-Ecology/conteStreamTemperature_northeast), [Data](http://db.ecosheds.org/), [Preprint](https://peerj.com/preprints/27069/),
...
**Hocking, D.J.**, J.M. Lanning, B. Galuardi, D. Linden, L.G. Smith, K. Winiarski, and B. McAfee. 2021 - present. MAPS: Monitoring Analysis Program System for implementing the Catch Accounting and Monitoring System. *Internal NOAA Only Software:* . [https://github.com/noaa-garfo/MAPS](https://github.com/noaa-garfo/MAPS).  [Public Website](https://www.greateratlantic.fisheries.noaa.gov/ro/fso/reports/cams/index.html)
...
Chamberlain, S., **D.J. Hocking**, B. Anderson, M. Salmon, A. Erickson, N. Potter, J. Stachelek, A. Simmons, K. Ram, and H. Edmund. 2020 - 2024. rnoaa: 'NOAA' Weather Data from R. R package version 1.3.8. [https://github.com/ropensci/rnoaa](https://github.com/ropensci/rnoaa). Deprecated due to API change.

**Hocking, D.J.** *In Prep*. noaaWeather: NOAA weather data from R for a new API. A replacement for the rnoaa package.
...
National Park Service. Survey of amphibian populations and disease in the Western C&O Canal National Historical Park. 2020. $35,000. *Declined and not included in award total*
...
Great Smoky Mountains Conservation Association. Carlos C. Campbell and James T. Tanner Memorial Fund. Short-term Effects of Wildlife on Salamander Populations in Great Smoky Mountains National Park. D.J. Hocking, J.A. Crawford, W.E. Peterman, J.R. Milanovich. 2017. $5,000
...
Department of Commerce Bronze Medal. 2026. Awarded to the Catch Accounting and Monitoring (CAMS) Team for development of an innovative shared data system to provide multi-mission support. US Department of Commerce.

Employee of the Year. 2022. Greater Atlantic Regional Fisheries Office. National Oceanic and Atmospheric Administration. US Department of Commerce.
...
Ryan Stephens (PhD, University of New Hampshire, 2018); Elizabeth Green (MS, Frostburg State University, 2019); Sabrina Edwards (MS, Frostburg State University, 2019); Emily Harlan (MS, Frostburg State University, 2019); Erica Duda (MS, Frostburg State University, 2019); Stephen Knott (MS, Frostburg State University, 2022)

## Undergraduate Researchers

I have mentored 14 undergraduate students (6 women, 8 men) on independent research projects, including multiple first generation college students and US military veterans. 
...
**Associate Editor**: Conservation Science and Practice, Society of Conservation Biology. 2023 - 2025
...
* Faculty Appeals Committee. 2019-2020.
...
* NOAA Longfin Squid Research Track Assessment Working Group. 2024 - 2026
6. [https://www.fisheries.noaa.gov/event/longfin-inshore-squid-research-track-working-group](https://www.fisheries.noaa.gov/event/longfin-inshore-squid-research-track-working-group)
