...
(citations = 692, *h*-index = 13, *i*10-index = 14)  
...
Below are a variety of tools I use in data science with proficiency listed roughly from advanced to basic. 

## Statistical

Hierarchical Bayesian Analysis, Generalized Linear Mixed Models, Mark-Recapture, Spatial Capture-Recapture, MCMC, HMC, Occupancy Modeling, Species Distribution Modeling, Geostatistical Spatial Analysis, Generalized Estimating Equations, Generalized Additive Models, CART, Random Forests

## Computational/Software

R, BUGS/JAGS/NIMBLE, Stan, TMB, git, SQL, C/C++, Markdown, LaTeX, Bash, GIS, Python, Make, MATLAB
